export const initHUD = () => {
    ...
    hudContainer.style.background = 'rgba(0, 50, 80, 0.4)';
    hudContainer.style.padding = '15px';
    hudContainer.style.borderRadius = '8px';
    hudContainer.style.border = '1px solid #00f0ff';
    hudContainer.style.boxShadow = '0 0 10px rgba(0, 240, 255, 0.3)';
    hudContainer.style.pointerEvents = 'none'; // 클릭 방해 방지
    hudContainer.innerHTML = `
        <h3 style="margin: 0 0 10px 0; color: #fff;">MULTIPLAYER SECURE LINK</h3>
        <p style="margin: 0;">• STATUS: <span style="color:#0f0">ONLINE</span></p>
        <p style="margin: 5px 0 0 0">• CONTROLS: W, A, S, D</p>
    `;
